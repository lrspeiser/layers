  ...
  return <section className="record-comparison-workbench">
    ...
    <div className="record-comparison-viewer">
      {pixelsAvailable ? <>
        ...
        {view === "coverage" && <img className="record-coverage-overlay" src={preview.assets.commonCoverage.path} alt="Orange marks pixels excluded from the common comparison mask" />}
        ...
        {view === "coverage" && <div className="main-overlay-legend"><strong>EXACT COMMON MASK</strong><span className="record-mask-key">Excluded from comparison</span><small>{(preview.commonValidPixelFraction * 100).toFixed(1)}% common valid area</small></div>}
